...
export default function CheckoutsPage() {
    ...
    const checkouts: CheckoutSession[] = [
        ...
        { id: "CHK-9910294", reference: "INV-2026-04", business: "Spayz Logistics", amount: "₦450,000.00", customerEmail: "sarah.j@company.com", paymentMethod: 'Bank Transfer', status: 'Pending', date: "Today, 09:15 AM", device: "Windows 11 / Chrome", ipAddress: "102.89.34.211", riskScore: 'Low' },
